...
- **Project Showcase:** Highlights full-stack applications like _Domasi Hub_, a campus utility platform.
...
The Firebase-hosted admin dashboard authenticates against vercel using a short-lived
